...
{
  ros::init(argc, argv, "vertical_problem_server_long");
  ros::NodeHandle n;
  ...
  ros::ServiceServer service = n.advertiseService("vertical_problem_long", get_solution);
  ROS_INFO("Ready to solve long vertical problem");
  ros::spin();
